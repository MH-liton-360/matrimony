    ...
    return (
        <section>
            <div className="navbar fixed z-10 
                bg-gradient-to-r from-white/40 via-white/50 to-transparent 
                ...
                <div className="w-full max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6">
                    ...
                    <div className="navbar-start flex-1 justify-center lg:justify-start">
                        ...
                        <div className="dropdown absolute left-0 lg:hidden">
                            ...
                            <ul
                                tabIndex="-1"
                                className="menu menu-sm dropdown-content bg-white/80 backdrop-blur-md rounded-box mt-3 w-72 p-2 shadow"
                            >
                                {navOptions}
                                <div className="flex gap-2">
                                    <li className="mt-2">
                                        <Link to="/login">
                                            <span className="btn btn-outline w-full text-white bg-accent-content border-white hover:bg-yellow-400 hover:border-yellow-400 hover:text-black">
                                                Login
                                            </span>
                                        </Link>
                                    </li>
                                    <li className="mt-2">
                                        <Link to="/signup">
                                            <span className="btn btn-outline w-full text-black bg-amber-50 border-white hover:bg-yellow-400 hover:border-yellow-400 hover:text-black">
                                                Create Account
                                            </span>
                                        </Link>
                                    </li>
